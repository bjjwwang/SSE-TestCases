; ModuleID = 'mac_bc/sys_func/SYS_cctype_iscntrl.ll'
source_filename = "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/sys_func/SYS_cctype_iscntrl.c"
...
land.rhs:                                         ; preds = %entry
  ...
  %call2 = call i32 @iscntrl(i32 noundef %conv1) #4, !dbg !26
  %tobool3 = icmp ne i32 %call2, 0, !dbg !27
  %lnot = xor i1 %tobool3, true, !dbg !27
  br label %land.end

land.end:                                         ; preds = %land.rhs, %entry
  %2 = phi i1 [ false, %entry ], [ %lnot, %land.rhs ], !dbg !28
  call void @svf_assert(i1 noundef zeroext %2), !dbg !29
  ret i32 0, !dbg !30
}
...
declare i32 @iscntrl(i32 noundef) #3
...
!1 = !DIFile(filename: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/sys_func/SYS_cctype_iscntrl.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!10 = !DIFile(filename: "src/sys_func/SYS_cctype_iscntrl.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!22 = !DILocation(line: 9, column: 24, scope: !9)
!23 = !DILocation(line: 9, column: 16, scope: !9)
!24 = !DILocation(line: 9, column: 27, scope: !9)
!25 = !DILocation(line: 9, column: 40, scope: !9)
!26 = !DILocation(line: 9, column: 32, scope: !9)
!27 = !DILocation(line: 9, column: 31, scope: !9)
