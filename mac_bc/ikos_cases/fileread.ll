; ModuleID = 'mac_bc/ikos_cases/fileread.ll'
source_filename = "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/ikos_cases/fileread.c"
...
entry:
  ...
  %2 = load %struct.__sFILE*, %struct.__sFILE** %fptr, align 8, !dbg !89
  %cmp = icmp eq %struct.__sFILE* %2, null, !dbg !91
  br i1 %cmp, label %if.then, label %if.end, !dbg !92

if.then:                                          ; preds = %entry
  %3 = load %struct.__sFILE*, %struct.__sFILE** %fptr, align 8, !dbg !93
  %cmp1 = icmp eq %struct.__sFILE* %3, null, !dbg !95
  %conv = zext i1 %cmp1 to i32, !dbg !95
  %call2 = call i32 (i32, ...) bitcast (i32 (...)* @svf_assert to i32 (i32, ...)*)(i32 noundef %conv), !dbg !96
  call void @exit(i32 noundef 1) #4, !dbg !97
  unreachable, !dbg !97

if.end:                                           ; preds = %entry
  %4 = load %struct.__sFILE*, %struct.__sFILE** %fptr, align 8, !dbg !98
  %cmp3 = icmp ne %struct.__sFILE* %4, null, !dbg !99
  %conv4 = zext i1 %cmp3 to i32, !dbg !99
  %call5 = call i32 (i32, ...) bitcast (i32 (...)* @svf_assert to i32 (i32, ...)*)(i32 noundef %conv4), !dbg !100
  call void @llvm.dbg.declare(metadata [60 x i8]* %str, metadata !101, metadata !DIExpression()), !dbg !105
  ret i32 0, !dbg !106
}
...
!1 = !DIFile(filename: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/ikos_cases/fileread.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
!2 = !{!3}
...
!12 = !DIFile(filename: "src/ikos_cases/fileread.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!89 = !DILocation(line: 6, column: 8, scope: !90)
!90 = distinct !DILexicalBlock(scope: !11, file: !12, line: 6, column: 8)
!91 = !DILocation(line: 6, column: 13, scope: !90)
!92 = !DILocation(line: 6, column: 8, scope: !11)
!93 = !DILocation(line: 8, column: 20, scope: !94)
!94 = distinct !DILexicalBlock(scope: !90, file: !12, line: 7, column: 5)
!95 = !DILocation(line: 8, column: 24, scope: !94)
!96 = !DILocation(line: 8, column: 9, scope: !94)
!97 = !DILocation(line: 9, column: 9, scope: !94)
!98 = !DILocation(line: 11, column: 16, scope: !11)
!99 = !DILocation(line: 11, column: 20, scope: !11)
!100 = !DILocation(line: 11, column: 5, scope: !11)
!101 = !DILocalVariable(name: "str", scope: !11, file: !12, line: 13, type: !102)
!102 = !DICompositeType(tag: DW_TAG_array_type, baseType: !18, size: 480, elements: !103)
!103 = !{!104}
!104 = !DISubrange(count: 60)
!105 = !DILocation(line: 13, column: 10, scope: !11)
!106 = !DILocation(line: 15, column: 1, scope: !11)
