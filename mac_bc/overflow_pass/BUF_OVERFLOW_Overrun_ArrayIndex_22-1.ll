; ModuleID = 'mac_bc/overflow_pass/BUF_OVERFLOW_Overrun_ArrayIndex_22-1.ll'
source_filename = "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/overflow_pass/BUF_OVERFLOW_Overrun_ArrayIndex_22-1.c"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata [20 x i32]* %buffer, metadata !15, metadata !DIExpression()), !dbg !19
  ...
  %rem2 = srem i32 %0, 5, !dbg !28
  store i32 %rem2, i32* %a, align 4, !dbg !29
  %1 = load i32, i32* %a, align 4, !dbg !30
  %idxprom = sext i32 %1 to i64, !dbg !31
  %arrayidx = getelementptr inbounds [20 x i32], [20 x i32]* %buffer, i64 0, i64 %idxprom, !dbg !31
...
!1 = !DIFile(filename: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/overflow_pass/BUF_OVERFLOW_Overrun_ArrayIndex_22-1.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!10 = !DIFile(filename: "src/overflow_pass/BUF_OVERFLOW_Overrun_ArrayIndex_22-1.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
!11 = !DISubroutineType(types: !12)
!12 = !{!13}
!13 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!14 = !{}
!15 = !DILocalVariable(name: "buffer", scope: !9, file: !10, line: 8, type: !16)
!16 = !DICompositeType(tag: DW_TAG_array_type, baseType: !13, size: 640, elements: !17)
!17 = !{!18}
...
!32 = !DILocation(line: 13, column: 15, scope: !9)
