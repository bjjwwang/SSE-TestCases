; ModuleID = 'mac_bc/overflow_pass/BUF_OVERFLOW_Recursive_Overrun_ArrayIndex_14-1.ll'
source_filename = "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/overflow_pass/BUF_OVERFLOW_Recursive_Overrun_ArrayIndex_14-1.c"
...
entry:
  %buffer1 = alloca [447 x i32], align 16
  %buffer2 = alloca [446 x i32], align 16
  %randomNumber = alloca i32, align 4
  %i = alloca i32, align 4
  call void @llvm.dbg.declare(metadata [447 x i32]* %buffer1, metadata !40, metadata !DIExpression()), !dbg !44
  call void @llvm.dbg.declare(metadata [446 x i32]* %buffer2, metadata !45, metadata !DIExpression()), !dbg !49
  ...
  %arrayidx = getelementptr inbounds [447 x i32], [447 x i32]* %buffer1, i64 0, i64 %idxprom, !dbg !61
  store i32 1, i32* %arrayidx, align 4, !dbg !62
  %2 = load i32, i32* %i, align 4, !dbg !63
  %idxprom3 = sext i32 %2 to i64, !dbg !64
  %arrayidx4 = getelementptr inbounds [446 x i32], [446 x i32]* %buffer2, i64 0, i64 %idxprom3, !dbg !64
...
!1 = !DIFile(filename: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/overflow_pass/BUF_OVERFLOW_Recursive_Overrun_ArrayIndex_14-1.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!10 = !DIFile(filename: "src/overflow_pass/BUF_OVERFLOW_Recursive_Overrun_ArrayIndex_14-1.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!41 = !DICompositeType(tag: DW_TAG_array_type, baseType: !13, size: 14304, elements: !42)
!42 = !{!43}
!43 = !DISubrange(count: 447)
!44 = !DILocation(line: 15, column: 9, scope: !37)
!45 = !DILocalVariable(name: "buffer2", scope: !37, file: !10, line: 16, type: !46)
!46 = !DICompositeType(tag: DW_TAG_array_type, baseType: !13, size: 14272, elements: !47)
!47 = !{!48}
!48 = !DISubrange(count: 446)
