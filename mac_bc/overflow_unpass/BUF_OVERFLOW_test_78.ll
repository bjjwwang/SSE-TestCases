; ModuleID = 'mac_bc/overflow_unpass/BUF_OVERFLOW_test_78.ll'
source_filename = "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/overflow_unpass/BUF_OVERFLOW_test_78.c"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata [1025 x i32]* %buffer1, metadata !79, metadata !DIExpression()), !dbg !83
  call void @llvm.dbg.declare(metadata [1024 x i32]* %buffer2, metadata !84, metadata !DIExpression()), !dbg !88
  call void @llvm.dbg.declare(metadata i32* %input, metadata !89, metadata !DIExpression()), !dbg !90
  store i32 2, i32* %input, align 4, !dbg !90
  call void @llvm.dbg.declare(metadata i32* %result, metadata !91, metadata !DIExpression()), !dbg !92
  %0 = load i32, i32* %input, align 4, !dbg !93
  %call = call i32 @a(i32 noundef %0), !dbg !94
  store i32 %call, i32* %result, align 4, !dbg !92
  %1 = load i32, i32* %result, align 4, !dbg !95
  %idxprom = sext i32 %1 to i64, !dbg !96
  %arrayidx = getelementptr inbounds [1025 x i32], [1025 x i32]* %buffer1, i64 0, i64 %idxprom, !dbg !96
  store i32 1, i32* %arrayidx, align 4, !dbg !97
  %2 = load i32, i32* %result, align 4, !dbg !98
  %idxprom1 = sext i32 %2 to i64, !dbg !99
  %arrayidx2 = getelementptr inbounds [1024 x i32], [1024 x i32]* %buffer2, i64 0, i64 %idxprom1, !dbg !99
  store i32 1, i32* %arrayidx2, align 4, !dbg !100
  ret i32 0, !dbg !101
}
...
!1 = !DIFile(filename: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/overflow_unpass/BUF_OVERFLOW_test_78.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!10 = !DIFile(filename: "src/overflow_unpass/BUF_OVERFLOW_test_78.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!59 = !DILocation(line: 42, column: 11, scope: !56)
!60 = !DILocation(line: 42, column: 9, scope: !56)
!61 = !DILocation(line: 42, column: 14, scope: !56)
!62 = !DILocation(line: 42, column: 2, scope: !56)
!63 = distinct !DISubprogram(name: "h", scope: !10, file: !10, line: 45, type: !11, scopeLine: 45, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !14)
!64 = !DILocalVariable(name: "x", arg: 1, scope: !63, file: !10, line: 45, type: !13)
!65 = !DILocation(line: 45, column: 11, scope: !63)
!66 = !DILocation(line: 46, column: 11, scope: !63)
!67 = !DILocation(line: 46, column: 9, scope: !63)
!68 = !DILocation(line: 46, column: 14, scope: !63)
!69 = !DILocation(line: 46, column: 2, scope: !63)
!70 = distinct !DISubprogram(name: "z", scope: !10, file: !10, line: 49, type: !11, scopeLine: 49, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !14)
!71 = !DILocalVariable(name: "x", arg: 1, scope: !70, file: !10, line: 49, type: !13)
!72 = !DILocation(line: 49, column: 11, scope: !70)
!73 = !DILocation(line: 50, column: 9, scope: !70)
!74 = !DILocation(line: 50, column: 11, scope: !70)
!75 = !DILocation(line: 50, column: 2, scope: !70)
!76 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 53, type: !77, scopeLine: 53, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !14)
!77 = !DISubroutineType(types: !78)
!78 = !{!13}
!79 = !DILocalVariable(name: "buffer1", scope: !76, file: !10, line: 54, type: !80)
!80 = !DICompositeType(tag: DW_TAG_array_type, baseType: !13, size: 32800, elements: !81)
!81 = !{!82}
!82 = !DISubrange(count: 1025)
!83 = !DILocation(line: 54, column: 6, scope: !76)
!84 = !DILocalVariable(name: "buffer2", scope: !76, file: !10, line: 55, type: !85)
!85 = !DICompositeType(tag: DW_TAG_array_type, baseType: !13, size: 32768, elements: !86)
!86 = !{!87}
!87 = !DISubrange(count: 1024)
!88 = !DILocation(line: 55, column: 6, scope: !76)
!89 = !DILocalVariable(name: "input", scope: !76, file: !10, line: 56, type: !13)
!90 = !DILocation(line: 56, column: 6, scope: !76)
!91 = !DILocalVariable(name: "result", scope: !76, file: !10, line: 57, type: !13)
!92 = !DILocation(line: 57, column: 6, scope: !76)
!93 = !DILocation(line: 57, column: 17, scope: !76)
!94 = !DILocation(line: 57, column: 15, scope: !76)
!95 = !DILocation(line: 59, column: 10, scope: !76)
!96 = !DILocation(line: 59, column: 2, scope: !76)
!97 = !DILocation(line: 59, column: 18, scope: !76)
!98 = !DILocation(line: 60, column: 10, scope: !76)
!99 = !DILocation(line: 60, column: 2, scope: !76)
!100 = !DILocation(line: 60, column: 18, scope: !76)
!101 = !DILocation(line: 61, column: 1, scope: !76)
