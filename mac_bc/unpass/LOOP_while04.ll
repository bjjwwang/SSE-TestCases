; ModuleID = 'mac_bc/unpass/LOOP_while04.ll'
source_filename = "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/unpass/LOOP_while04.c"
...
entry:
  ...
  store i32 3, i32* %n, align 4, !dbg !23
...
if.then:                                          ; preds = %while.body
  ...
  store i32 %dec, i32* %y, align 4, !dbg !32
  br label %if.end, !dbg !33

if.end:                                           ; preds = %if.then, %while.body
  %4 = load i32, i32* %n, align 4, !dbg !34
  %dec2 = add nsw i32 %4, -1, !dbg !34
  store i32 %dec2, i32* %n, align 4, !dbg !34
  br label %while.cond, !dbg !24, !llvm.loop !35

while.end:                                        ; preds = %while.cond
  %5 = load i32, i32* %x, align 4, !dbg !38
  %6 = load i32, i32* %y, align 4, !dbg !39
  %add = add nsw i32 %5, %6, !dbg !40
  %cmp = icmp eq i32 %add, 2, !dbg !41
...
!1 = !DIFile(filename: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/unpass/LOOP_while04.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!10 = !DIFile(filename: "src/unpass/LOOP_while04.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!39 = !DILocation(line: 20, column: 20, scope: !9)
!40 = !DILocation(line: 20, column: 19, scope: !9)
