; ModuleID = 'mac_bc/unpass/SYS_cmath_tan.ll'
source_filename = "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/unpass/SYS_cmath_tan.c"
...
entry:
  ...
  store double 4.500000e+01, double* %param, align 8, !dbg !20
  ...
  %call = call double @tan(double noundef %div) #4, !dbg !24
  store double %call, double* %result, align 8, !dbg !25
  %1 = load double, double* %result, align 8, !dbg !26
  %sub = fsub double %1, 1.000000e+00, !dbg !27
  %cmp = fcmp olt double %sub, 1.000000e-02, !dbg !28
...
!1 = !DIFile(filename: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases/src/unpass/SYS_cmath_tan.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!10 = !DIFile(filename: "src/unpass/SYS_cmath_tan.c", directory: "/Users/jiaweiwang/CLionProjects/0130-db/svf-z3/SSE-TestCases")
...
!28 = !DILocation(line: 12, column: 29, scope: !9)
