; ModuleID = 'linux_bc/pass/BASIC_switch.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/pass/BASIC_switch.c"
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb
  ...
  %conv5 = zext i1 %cmp to i32, !dbg !39
  %call = call i32 (i32, ...) bitcast (i32 (...)* @svf_assert to i32 (i32, ...)*)(i32 %conv5), !dbg !40
  ret i32 0, !dbg !41
}
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/pass/BASIC_switch.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/pass/BASIC_switch.c", directory: "/home/SVF-tools/SSE-TestCases")
