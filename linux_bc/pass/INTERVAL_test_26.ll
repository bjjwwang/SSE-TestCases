; ModuleID = 'linux_bc/pass/INTERVAL_test_26.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/pass/INTERVAL_test_26.c"
...
entry:
  ...
  %cmp = icmp sge i32 %1, 0, !dbg !20
  br i1 %cmp, label %land.rhs, label %land.end, !dbg !21

land.rhs:                                         ; preds = %entry
  %2 = load i32, i32* %a, align 4, !dbg !22
  %cmp1 = icmp slt i32 %2, 5, !dbg !23
  br label %land.end

land.end:                                         ; preds = %land.rhs, %entry
  %3 = phi i1 [ false, %entry ], [ %cmp1, %land.rhs ], !dbg !24
  call void @svf_assert(i1 zeroext %3), !dbg !25
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/pass/INTERVAL_test_26.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/pass/INTERVAL_test_26.c", directory: "/home/SVF-tools/SSE-TestCases")
...
!19 = !DILocation(line: 8, column: 16, scope: !9)
!20 = !DILocation(line: 8, column: 18, scope: !9)
!21 = !DILocation(line: 8, column: 23, scope: !9)
!22 = !DILocation(line: 8, column: 26, scope: !9)
!23 = !DILocation(line: 8, column: 28, scope: !9)
