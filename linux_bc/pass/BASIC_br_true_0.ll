; ModuleID = 'linux_bc/pass/BASIC_br_true_0.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/pass/BASIC_br_true_0.c"
...
entry:
  ...
  %inc1 = add nsw i32 %1, 1, !dbg !23
  store i32 %inc1, i32* %y, align 4, !dbg !23
  %2 = load i32, i32* %x, align 4, !dbg !24
  %3 = load i32, i32* %y, align 4, !dbg !25
  %cmp = icmp eq i32 %2, %3, !dbg !26
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/pass/BASIC_br_true_0.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/pass/BASIC_br_true_0.c", directory: "/home/SVF-tools/SSE-TestCases")
...
!20 = !DILocation(line: 16, column: 10, scope: !21)
!21 = distinct !DILexicalBlock(scope: !22, file: !10, line: 15, column: 15)
!22 = distinct !DILexicalBlock(scope: !9, file: !10, line: 15, column: 9)
!23 = !DILocation(line: 17, column: 10, scope: !21)
!24 = !DILocation(line: 19, column: 16, scope: !9)
!25 = !DILocation(line: 19, column: 21, scope: !9)
!26 = !DILocation(line: 19, column: 18, scope: !9)
!27 = !DILocation(line: 19, column: 5, scope: !9)
