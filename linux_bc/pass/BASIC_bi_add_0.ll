; ModuleID = 'linux_bc/pass/BASIC_bi_add_0.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/pass/BASIC_bi_add_0.c"
...
entry:
  ...
  %add = add nsw i32 %0, 3, !dbg !16
  store i32 %add, i32* %x, align 4, !dbg !16
  %1 = load i32, i32* %x, align 4, !dbg !17
  %cmp = icmp eq i32 %1, 2, !dbg !18
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/pass/BASIC_bi_add_0.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/pass/BASIC_bi_add_0.c", directory: "/home/SVF-tools/SSE-TestCases")
!11 = !DISubroutineType(types: !12)
!12 = !{!13}
!13 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!14 = !DILocalVariable(name: "x", scope: !9, file: !10, line: 5, type: !13)
!15 = !DILocation(line: 5, column: 9, scope: !9)
!16 = !DILocation(line: 6, column: 7, scope: !9)
!17 = !DILocation(line: 7, column: 16, scope: !9)
