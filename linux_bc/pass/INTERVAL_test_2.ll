; ModuleID = 'linux_bc/pass/INTERVAL_test_2.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/pass/INTERVAL_test_2.c"
...
entry:
  ...
  %call = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %a), !dbg !18
...
if.then:                                          ; preds = %entry
  ...
  call void @svf_assert(i1 zeroext %cmp1), !dbg !30
  br label %if.end, !dbg !31

if.else:                                          ; preds = %entry
  %4 = load i32, i32* %b, align 4, !dbg !32
  %cmp2 = icmp sle i32 %4, 5, !dbg !34
  call void @svf_assert(i1 zeroext %cmp2), !dbg !35
  br label %if.end
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/pass/INTERVAL_test_2.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/pass/INTERVAL_test_2.c", directory: "/home/SVF-tools/SSE-TestCases")
...
!24 = distinct !DILexicalBlock(scope: !9, file: !10, line: 10, column: 9)
!25 = !DILocation(line: 10, column: 11, scope: !24)
!26 = !DILocation(line: 10, column: 9, scope: !9)
!27 = !DILocation(line: 11, column: 20, scope: !28)
!28 = distinct !DILexicalBlock(scope: !24, file: !10, line: 10, column: 16)
!29 = !DILocation(line: 11, column: 22, scope: !28)
!30 = !DILocation(line: 11, column: 9, scope: !28)
!31 = !DILocation(line: 12, column: 5, scope: !28)
!32 = !DILocation(line: 14, column: 20, scope: !33)
!33 = distinct !DILexicalBlock(scope: !24, file: !10, line: 13, column: 10)
!34 = !DILocation(line: 14, column: 22, scope: !33)
!35 = !DILocation(line: 14, column: 9, scope: !33)
!36 = !DILocation(line: 16, column: 1, scope: !9)
