; ModuleID = 'linux_bc/pass/BASIC_bi_mix_0.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/pass/BASIC_bi_mix_0.c"
...
entry:
  ...
  store i32 %sub, i32* %b, align 4, !dbg !22
  %3 = load i32, i32* %a, align 4, !dbg !23
  %cmp = icmp eq i32 %3, 3, !dbg !24
  br i1 %cmp, label %land.rhs, label %land.end, !dbg !25

land.rhs:                                         ; preds = %entry
  %4 = load i32, i32* %b, align 4, !dbg !26
  %cmp1 = icmp eq i32 %4, 2, !dbg !27
  br label %land.end

land.end:                                         ; preds = %land.rhs, %entry
  %5 = phi i1 [ false, %entry ], [ %cmp1, %land.rhs ], !dbg !28
  call void @svf_assert(i1 zeroext %5), !dbg !29
  ret i32 0, !dbg !30
}
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/pass/BASIC_bi_mix_0.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/pass/BASIC_bi_mix_0.c", directory: "/home/SVF-tools/SSE-TestCases")
...
!22 = !DILocation(line: 8, column: 7, scope: !9)
!23 = !DILocation(line: 9, column: 17, scope: !9)
!24 = !DILocation(line: 9, column: 19, scope: !9)
!25 = !DILocation(line: 9, column: 24, scope: !9)
!26 = !DILocation(line: 9, column: 27, scope: !9)
