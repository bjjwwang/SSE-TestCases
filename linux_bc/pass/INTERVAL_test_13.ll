; ModuleID = 'linux_bc/pass/INTERVAL_test_13.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/pass/INTERVAL_test_13.c"
...
entry:
  ...
  store i32 %mul, i32* %b, align 4, !dbg !21
...
if.then:                                          ; preds = %entry
  ...
  %cmp1 = icmp sle i32 %3, -12, !dbg !28
  call void @svf_assert(i1 zeroext %cmp1), !dbg !29
  br label %if.end, !dbg !30

if.else:                                          ; preds = %entry
  %4 = load i32, i32* %b, align 4, !dbg !31
  %cmp2 = icmp sgt i32 %4, -12, !dbg !33
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/pass/INTERVAL_test_13.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/pass/INTERVAL_test_13.c", directory: "/home/SVF-tools/SSE-TestCases")
...
!23 = distinct !DILexicalBlock(scope: !9, file: !10, line: 8, column: 9)
!24 = !DILocation(line: 8, column: 11, scope: !23)
!25 = !DILocation(line: 8, column: 9, scope: !9)
!26 = !DILocation(line: 9, column: 20, scope: !27)
!27 = distinct !DILexicalBlock(scope: !23, file: !10, line: 8, column: 16)
!28 = !DILocation(line: 9, column: 22, scope: !27)
!29 = !DILocation(line: 9, column: 9, scope: !27)
!30 = !DILocation(line: 10, column: 5, scope: !27)
!31 = !DILocation(line: 12, column: 20, scope: !32)
!32 = distinct !DILexicalBlock(scope: !23, file: !10, line: 11, column: 10)
!33 = !DILocation(line: 12, column: 22, scope: !32)
