; ModuleID = 'linux_bc/overflow_pass/BUF_OVERFLOW_Recursive_Overrun_ArrayIndex_14-1.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/overflow_pass/BUF_OVERFLOW_Recursive_Overrun_ArrayIndex_14-1.c"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata [447 x i32]* %buffer1, metadata !39, metadata !DIExpression()), !dbg !43
  call void @llvm.dbg.declare(metadata [446 x i32]* %buffer2, metadata !44, metadata !DIExpression()), !dbg !48
  ...
  %arrayidx = getelementptr inbounds [447 x i32], [447 x i32]* %buffer1, i64 0, i64 %idxprom, !dbg !60
  store i32 1, i32* %arrayidx, align 4, !dbg !61
  %2 = load i32, i32* %i, align 4, !dbg !62
  %idxprom3 = sext i32 %2 to i64, !dbg !63
  %arrayidx4 = getelementptr inbounds [446 x i32], [446 x i32]* %buffer2, i64 0, i64 %idxprom3, !dbg !63
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/overflow_pass/BUF_OVERFLOW_Recursive_Overrun_ArrayIndex_14-1.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/overflow_pass/BUF_OVERFLOW_Recursive_Overrun_ArrayIndex_14-1.c", directory: "/home/SVF-tools/SSE-TestCases")
...
!40 = !DICompositeType(tag: DW_TAG_array_type, baseType: !13, size: 14304, elements: !41)
!41 = !{!42}
!42 = !DISubrange(count: 447)
!43 = !DILocation(line: 15, column: 9, scope: !36)
!44 = !DILocalVariable(name: "buffer2", scope: !36, file: !10, line: 16, type: !45)
!45 = !DICompositeType(tag: DW_TAG_array_type, baseType: !13, size: 14272, elements: !46)
!46 = !{!47}
!47 = !DISubrange(count: 446)
