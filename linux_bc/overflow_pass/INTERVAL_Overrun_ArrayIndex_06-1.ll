; ModuleID = 'linux_bc/overflow_pass/INTERVAL_Overrun_ArrayIndex_06-1.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/overflow_pass/INTERVAL_Overrun_ArrayIndex_06-1.c"
...
entry:
  ...
  %call = call i32 (i32, ...) bitcast (i32 (...)* @time to i32 (i32, ...)*)(i32 0), !dbg !85
  call void @srand(i32 %call) #5, !dbg !86
  call void @llvm.dbg.declare(metadata i32* %randomNumber, metadata !87, metadata !DIExpression()), !dbg !88
  %call1 = call i32 @rand() #5, !dbg !89
  %rem = srem i32 %call1, 31, !dbg !90
  store i32 %rem, i32* %randomNumber, align 4, !dbg !88
  call void @llvm.dbg.declare(metadata i32* %i, metadata !91, metadata !DIExpression()), !dbg !92
  %0 = load i32, i32* %randomNumber, align 4, !dbg !93
  %call2 = call i32 @baseConversion(i32 %0, i32 8), !dbg !94
  store i32 %call2, i32* %i, align 4, !dbg !92
  %1 = load i32, i32* %i, align 4, !dbg !95
  %cmp = icmp sge i32 %1, 0, !dbg !96
  br i1 %cmp, label %land.rhs, label %land.end, !dbg !97

land.rhs:                                         ; preds = %entry
  %2 = load i32, i32* %i, align 4, !dbg !98
  %cmp3 = icmp sle i32 %2, 36, !dbg !99
  br label %land.end

land.end:                                         ; preds = %land.rhs, %entry
  %3 = phi i1 [ false, %entry ], [ %cmp3, %land.rhs ], !dbg !100
  call void @svf_assert(i1 zeroext %3), !dbg !101
  %4 = load i32, i32* %retval, align 4, !dbg !102
  ret i32 %4, !dbg !102
}
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/overflow_pass/INTERVAL_Overrun_ArrayIndex_06-1.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/overflow_pass/INTERVAL_Overrun_ArrayIndex_06-1.c", directory: "/home/SVF-tools/SSE-TestCases")
...
!52 = !DILocalVariable(name: "buffer", scope: !9, file: !10, line: 19, type: !47)
!53 = !DILocation(line: 19, column: 10, scope: !9)
!54 = !DILocation(line: 20, column: 13, scope: !9)
!55 = !DILocation(line: 20, column: 27, scope: !9)
!56 = !DILocation(line: 20, column: 5, scope: !9)
!57 = !DILabel(scope: !9, name: "LOOPENTRY", file: !10, line: 21)
!58 = !DILocation(line: 21, column: 5, scope: !9)
!59 = !DILocation(line: 22, column: 8, scope: !60)
!60 = distinct !DILexicalBlock(scope: !9, file: !10, line: 22, column: 8)
!61 = !DILocation(line: 22, column: 19, scope: !60)
!62 = !DILocation(line: 22, column: 8, scope: !9)
!63 = !DILocation(line: 23, column: 9, scope: !64)
!64 = distinct !DILexicalBlock(scope: !60, file: !10, line: 22, column: 25)
!65 = !DILocation(line: 26, column: 9, scope: !66)
!66 = distinct !DILexicalBlock(scope: !60, file: !10, line: 25, column: 10)
!67 = !DILabel(scope: !9, name: "LOOP", file: !10, line: 28)
!68 = !DILocation(line: 28, column: 5, scope: !9)
!69 = !DILocation(line: 29, column: 13, scope: !9)
!70 = !DILocation(line: 29, column: 33, scope: !9)
!71 = !DILocation(line: 29, column: 27, scope: !9)
!72 = !DILocation(line: 29, column: 5, scope: !9)
!73 = !DILocation(line: 30, column: 12, scope: !9)
!74 = !DILocation(line: 30, column: 20, scope: !9)
!75 = !DILocation(line: 30, column: 5, scope: !9)
!76 = !DILocation(line: 31, column: 5, scope: !9)
!77 = !DILabel(scope: !9, name: "LOOPEXIT", file: !10, line: 32)
!78 = !DILocation(line: 32, column: 5, scope: !9)
!79 = !DILocation(line: 33, column: 17, scope: !9)
!80 = !DILocation(line: 33, column: 12, scope: !9)
!81 = !DILocation(line: 33, column: 5, scope: !9)
!82 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 36, type: !83, scopeLine: 36, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!83 = !DISubroutineType(types: !84)
!84 = !{!13}
!85 = !DILocation(line: 37, column: 11, scope: !82)
!86 = !DILocation(line: 37, column: 5, scope: !82)
!87 = !DILocalVariable(name: "randomNumber", scope: !82, file: !10, line: 38, type: !13)
!88 = !DILocation(line: 38, column: 9, scope: !82)
!89 = !DILocation(line: 38, column: 24, scope: !82)
!90 = !DILocation(line: 38, column: 31, scope: !82)
!91 = !DILocalVariable(name: "i", scope: !82, file: !10, line: 40, type: !13)
!92 = !DILocation(line: 40, column: 9, scope: !82)
!93 = !DILocation(line: 40, column: 28, scope: !82)
!94 = !DILocation(line: 40, column: 13, scope: !82)
!95 = !DILocation(line: 41, column: 16, scope: !82)
!96 = !DILocation(line: 41, column: 18, scope: !82)
!97 = !DILocation(line: 41, column: 23, scope: !82)
!98 = !DILocation(line: 41, column: 26, scope: !82)
!99 = !DILocation(line: 41, column: 28, scope: !82)
!100 = !DILocation(line: 0, scope: !82)
!101 = !DILocation(line: 41, column: 5, scope: !82)
!102 = !DILocation(line: 42, column: 1, scope: !82)
