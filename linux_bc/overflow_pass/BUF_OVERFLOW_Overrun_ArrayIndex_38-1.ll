; ModuleID = 'linux_bc/overflow_pass/BUF_OVERFLOW_Overrun_ArrayIndex_38-1.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/overflow_pass/BUF_OVERFLOW_Overrun_ArrayIndex_38-1.c"
...
entry:
  ...
  call void @llvm.dbg.declare(metadata [37 x i32]* %buffer1, metadata !82, metadata !DIExpression()), !dbg !86
  call void @llvm.dbg.declare(metadata [36 x i32]* %buffer2, metadata !87, metadata !DIExpression()), !dbg !91
  %call = call i32 (i32, ...) bitcast (i32 (...)* @time to i32 (i32, ...)*)(i32 0), !dbg !92
  call void @srand(i32 %call) #5, !dbg !93
  call void @llvm.dbg.declare(metadata i32* %randomNumber, metadata !94, metadata !DIExpression()), !dbg !95
  %call1 = call i32 @rand() #5, !dbg !96
  %rem = srem i32 %call1, 31, !dbg !97
  store i32 %rem, i32* %randomNumber, align 4, !dbg !95
  call void @llvm.dbg.declare(metadata i32* %i, metadata !98, metadata !DIExpression()), !dbg !99
  %0 = load i32, i32* %randomNumber, align 4, !dbg !100
  %call2 = call i32 @baseConversion(i32 %0, i32 8), !dbg !101
  store i32 %call2, i32* %i, align 4, !dbg !99
  %1 = load i32, i32* %i, align 4, !dbg !102
  %idxprom = sext i32 %1 to i64, !dbg !103
  %arrayidx = getelementptr inbounds [37 x i32], [37 x i32]* %buffer1, i64 0, i64 %idxprom, !dbg !103
  store i32 1, i32* %arrayidx, align 4, !dbg !104
  %2 = load i32, i32* %i, align 4, !dbg !105
  %idxprom3 = sext i32 %2 to i64, !dbg !106
  %arrayidx4 = getelementptr inbounds [36 x i32], [36 x i32]* %buffer2, i64 0, i64 %idxprom3, !dbg !106
  store i32 1, i32* %arrayidx4, align 4, !dbg !107
  ret i32 0, !dbg !108
}
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/overflow_pass/BUF_OVERFLOW_Overrun_ArrayIndex_38-1.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/overflow_pass/BUF_OVERFLOW_Overrun_ArrayIndex_38-1.c", directory: "/home/SVF-tools/SSE-TestCases")
...
!74 = !DILabel(scope: !9, name: "ENDLOOP", file: !10, line: 27)
!75 = !DILocation(line: 27, column: 5, scope: !9)
!76 = !DILocation(line: 28, column: 17, scope: !9)
!77 = !DILocation(line: 28, column: 12, scope: !9)
!78 = !DILocation(line: 28, column: 5, scope: !9)
!79 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 31, type: !80, scopeLine: 31, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!80 = !DISubroutineType(types: !81)
!81 = !{!13}
!82 = !DILocalVariable(name: "buffer1", scope: !79, file: !10, line: 32, type: !83)
!83 = !DICompositeType(tag: DW_TAG_array_type, baseType: !13, size: 1184, elements: !84)
!84 = !{!85}
!85 = !DISubrange(count: 37)
!86 = !DILocation(line: 32, column: 6, scope: !79)
!87 = !DILocalVariable(name: "buffer2", scope: !79, file: !10, line: 33, type: !88)
!88 = !DICompositeType(tag: DW_TAG_array_type, baseType: !13, size: 1152, elements: !89)
!89 = !{!90}
!90 = !DISubrange(count: 36)
!91 = !DILocation(line: 33, column: 6, scope: !79)
!92 = !DILocation(line: 34, column: 11, scope: !79)
!93 = !DILocation(line: 34, column: 5, scope: !79)
!94 = !DILocalVariable(name: "randomNumber", scope: !79, file: !10, line: 35, type: !13)
!95 = !DILocation(line: 35, column: 9, scope: !79)
!96 = !DILocation(line: 35, column: 24, scope: !79)
!97 = !DILocation(line: 35, column: 31, scope: !79)
!98 = !DILocalVariable(name: "i", scope: !79, file: !10, line: 37, type: !13)
!99 = !DILocation(line: 37, column: 9, scope: !79)
!100 = !DILocation(line: 37, column: 28, scope: !79)
!101 = !DILocation(line: 37, column: 13, scope: !79)
!102 = !DILocation(line: 39, column: 10, scope: !79)
!103 = !DILocation(line: 39, column: 2, scope: !79)
!104 = !DILocation(line: 39, column: 13, scope: !79)
!105 = !DILocation(line: 40, column: 10, scope: !79)
!106 = !DILocation(line: 40, column: 2, scope: !79)
!107 = !DILocation(line: 40, column: 13, scope: !79)
!108 = !DILocation(line: 41, column: 1, scope: !79)
