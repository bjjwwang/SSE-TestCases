; ModuleID = 'linux_bc/overflow_pass/INTERVAL_Overrun_ArrayIndex_05-1.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/overflow_pass/INTERVAL_Overrun_ArrayIndex_05-1.c"
...
entry:
  ...
  %call = call i32 (i32, ...) bitcast (i32 (...)* @time to i32 (i32, ...)*)(i32 0), !dbg !80
  call void @srand(i32 %call) #5, !dbg !81
  call void @llvm.dbg.declare(metadata i32* %randomNumber, metadata !82, metadata !DIExpression()), !dbg !83
  %call1 = call i32 @rand() #5, !dbg !84
  ...
  %call2 = call i32 @baseConversion(i32 %0, i32 8), !dbg !89
  store i32 %call2, i32* %i, align 4, !dbg !87
  %1 = load i32, i32* %i, align 4, !dbg !90
  %cmp = icmp sge i32 %1, 0, !dbg !91
  br i1 %cmp, label %land.rhs, label %land.end, !dbg !92

land.rhs:                                         ; preds = %entry
  %2 = load i32, i32* %i, align 4, !dbg !93
  %cmp3 = icmp sle i32 %2, 36, !dbg !94
  br label %land.end

land.end:                                         ; preds = %land.rhs, %entry
  %3 = phi i1 [ false, %entry ], [ %cmp3, %land.rhs ], !dbg !95
  call void @svf_assert(i1 zeroext %3), !dbg !96
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/overflow_pass/INTERVAL_Overrun_ArrayIndex_05-1.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/overflow_pass/INTERVAL_Overrun_ArrayIndex_05-1.c", directory: "/home/SVF-tools/SSE-TestCases")
...
!74 = !DILocation(line: 28, column: 17, scope: !9)
!75 = !DILocation(line: 28, column: 12, scope: !9)
!76 = !DILocation(line: 28, column: 5, scope: !9)
!77 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 31, type: !78, scopeLine: 31, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!78 = !DISubroutineType(types: !79)
!79 = !{!13}
!80 = !DILocation(line: 32, column: 11, scope: !77)
!81 = !DILocation(line: 32, column: 5, scope: !77)
!82 = !DILocalVariable(name: "randomNumber", scope: !77, file: !10, line: 33, type: !13)
!83 = !DILocation(line: 33, column: 9, scope: !77)
!84 = !DILocation(line: 33, column: 24, scope: !77)
!85 = !DILocation(line: 33, column: 31, scope: !77)
!86 = !DILocalVariable(name: "i", scope: !77, file: !10, line: 35, type: !13)
!87 = !DILocation(line: 35, column: 9, scope: !77)
!88 = !DILocation(line: 35, column: 28, scope: !77)
!89 = !DILocation(line: 35, column: 13, scope: !77)
!90 = !DILocation(line: 36, column: 16, scope: !77)
!91 = !DILocation(line: 36, column: 18, scope: !77)
!92 = !DILocation(line: 36, column: 23, scope: !77)
!93 = !DILocation(line: 36, column: 26, scope: !77)
!94 = !DILocation(line: 36, column: 28, scope: !77)
!95 = !DILocation(line: 0, scope: !77)
!96 = !DILocation(line: 36, column: 5, scope: !77)
!97 = !DILocation(line: 37, column: 1, scope: !77)
