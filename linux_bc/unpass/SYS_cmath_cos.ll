; ModuleID = 'linux_bc/unpass/SYS_cmath_cos.ll'
source_filename = "/home/SVF-tools/SSE-TestCases/src/unpass/SYS_cmath_cos.c"
...
entry:
  ...
  store double 6.000000e+01, double* %param, align 8, !dbg !19
  ...
  %call = call double @cos(double %div) #4, !dbg !23
  store double %call, double* %result, align 8, !dbg !24
  %1 = load double, double* %result, align 8, !dbg !25
  %sub = fsub double %1, 5.000000e-01, !dbg !26
  %cmp = fcmp olt double %sub, 1.000000e-03, !dbg !27
...
!1 = !DIFile(filename: "/home/SVF-tools/SSE-TestCases/src/unpass/SYS_cmath_cos.c", directory: "/home/SVF-tools/SSE-TestCases")
!2 = !{}
...
!10 = !DIFile(filename: "src/unpass/SYS_cmath_cos.c", directory: "/home/SVF-tools/SSE-TestCases")
...
!27 = !DILocation(line: 12, column: 30, scope: !9)
